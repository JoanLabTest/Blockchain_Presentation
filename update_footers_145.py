...
for file_path in html_files:
    ...
    # Root level pattern
    root_pattern = re.compile(r'<li><a href="mrm-hub\.html">MRM Hub</a></li>\s*<li><a href="regulatory-mapping\.html">Regulatory Mapping</a></li>')
    root_replacement = """<li><a href="mrm-hub.html">MRM Hub</a></li>
    ...
    sub_pattern = re.compile(r'<li><a href="\.\./mrm-hub\.html">MRM Hub</a></li>\s*<li><a href="\.\./regulatory-mapping\.html">Regulatory Mapping</a></li>')
    sub_replacement = """<li><a href="../mrm-hub.html">MRM Hub</a></li>
                    <li><a href="../data-certification.html">Data Trust Certif</a></li>
                    <li><a href="../regulatory-mapping.html">Regulatory Mapping</a></li>"""
