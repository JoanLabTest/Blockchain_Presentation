/**
 * DCM Core Institute – Guided Experience Layer (Brique 4) [EN]
    ...
    const personas = [
        {
            ...
            desc: 'Access live market data, the GTSR registry, the query terminal, and institutional research reports.',
            links: [
                { text: 'Market Observatory', href: 'observatory/tokenized-markets.html', icon: 'fa-chart-line' },
                { text: 'Global Monitor (TVL/RWA)', href: 'observatory/global-tokenization-monitor.html', icon: 'fa-globe' },
                { text: 'Global Report 2026', href: 'research/global-tokenization-report.html', icon: 'fa-crown' },
            ]
        },
        {
            id: 'bank',
            ...
            desc: 'Explore technical blueprints, TFIN-ID standards, and MiCA / DORA compliance frameworks for your deployment.',
            links: [
                { text: 'Blueprint Gallery', href: 'standards/blueprints/index.html', icon: 'fa-layer-group' },
                { text: 'TFIN-ID Standard', href: 'standards/tfin-id.html', icon: 'fa-id-card' },
                { text: 'PCM Framework', href: 'research/programmable-capital-markets/index.html', icon: 'fa-microchip' },
            ]
        },
        {
            id: 'investor',
            ...
            colorRgb: '16,185,129',
            label: 'INVESTOR',
            title: 'Investor / Portfolio Manager',
            desc: 'Discover institutional RWA strategies, analyses of tokenized products, and optimized yield tools.',
            links: [
                { text: 'BlackRock ETHB Strategy', href: 'strategies/blackrock-ethb-staked-ethereum-etf.html', icon: 'fa-gem' },
                { text: 'Hashnote USYC (T-Bills)', href: 'strategies/usyc-tresor-tokenise.html', icon: 'fa-vault' },
                { text: 'Covered Call ETF', href: 'strategies/etf-covered-call.html', icon: 'fa-arrows-left-right-to-line' },
            ]
        }
    ];
