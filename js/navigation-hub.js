...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (searchInput && searchResults) {
        const institutionalKeywords = {
            ...
            'monitor': { id: 'OBS_MONITOR', title: 'Global Tokenization Monitor (Real-time)' },
            'gtsr': { id: 'GTSR_TS', title: 'GTSR Time-Series Data (Historical)' },
            'time-series': { id: 'GTSR_TS', title: 'GTSR Time-Series Data (Historical)' },
